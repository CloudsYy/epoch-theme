...
<head>
  ...
  <title>${settings.general.items.home_title.label}</title>
  ...
  <div>
      ...
      <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
          <div class="carousel-container">
            <div class="carousel-container-bg animate__animated animate__pulse" style="background-image:url('[field:litpic /]')"> </div>
        ...
        <!--子循环项1-->
        <!-- Slide 2 -->
        {dreamer-cms:list typeid="7RL6AA80" pagenum="1" pagesize="4" flag="p" formkey="SI555I4P" addfields="content"}
        <div class="carousel-item">
          <div class="carousel-container">
            <div class="carousel-container-bg animate__animated animate__pulse" style="background-image:url('[field:litpic /]"> </div>
            <div class="carousel-item-info">
              <h2 class="animate__animated animate__fadeInDown">[field:title function="substring(0,25,'...')" /]</h2>
              <div class="sub-title animate__animated animate__bounceInRight">[field:remark /]</div>
              <a href="[field:arcurl/]" class="btn-get-started  scrollto">查看详情</a>
            </div>
          </div>
    ...
    <main id="main">
      ...
      <section id="icon-boxes" class="icon-boxes">
        <div class="container">
          <div class="row">
            {dreamer-cms:list typeid="I3SB7IDV" pagenum="1" pagesize="4" flag="p" formkey="G46TRD3I" addfields="content"}
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up">
              <div class="icon-box">
                <div class="feature-image"><img src="[field:litpic /]" class="ion ion-ios-cloud-outline"></i></div>
                <h4 class="title"><a href="[field:arcurl/]">[field:title function="substring(0,50,'...')" /]</a></h4>
              </div>
            </div>
            {/dreamer-cms:list}
          </div>
      ...
      <section id="portfolio" class="portfoio">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row portfolio-container">
            <!--    新材料      -->
            {dreamer-cms:list typeid="50Q0944J" pagenum="0" pagesize="8" flag="p" formkey="82XFVKIQ" addfields="link"}
            ...
            <!--    新能源      -->
            {dreamer-cms:list typeid="N96K09J0" pagenum="0" pagesize="8" flag="p" formkey="82XFVKIQ" addfields="link"}
            ...
            <!--    通信设备      -->
            {dreamer-cms:list typeid="L8N6X165" pagenum="0" pagesize="8" flag="p" formkey="82XFVKIQ" addfields="link"}
        ...
        <div class="container" data-aos="zoom-in">
          <div class="clients-slider swiper-container">
            <div class="swiper-wrapper align-items-center">
              {dreamer-cms:list typeid="S1P5NUE1" pagenum="0" pagesize="8" flag="p" formkey="82XFVKIQ" addfields="link"}
      ...
      <section id="team" class="team section-bg">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row">
            {dreamer-cms:list typeid="MR98DA58" pagenum="1" pagesize="4" flag="p" formkey="V1WL66A0" addfields="content"}
            <div>
              <h2 style="margin-bottom: 20px;margin-top: 20px"><a href="[field:arcurl /]">[field:title /]</a></h2>
              <p>[field:remark /]</p>
            </div>
            {/dreamer-cms:list}
          </div>
